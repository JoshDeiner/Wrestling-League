...
const data = [
  createData('TeamOne', 159, 6.0, 24, 4.0),
  createData('TeamTwo', 237, 9.0, 37, 4.3),
  createData('TeamThree', 262, 16.0, 24, 6.0),
  createData('TeamFour', 305, 3.7, 67, 4.3),
  createData('TeamFive', 356, 16.0, 49, 3.9),
];
